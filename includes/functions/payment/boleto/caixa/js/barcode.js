...
url = 'https://cfcarehospitalar.com.br/wp-content/plugins/wpstore/includes/functions/payment/boleto/caixa/';

var BAR_BLACK  = "<img src='"+url+"images/black.jpg' height='"+BAR_HEIGHT+"' width="+BAR_WIDTH+">";
var BAR_WHITE  = "<img src='"+url+"images/white.jpg' height='"+BAR_HEIGHT+"' width="+BAR_WIDTH+">";
var BAR_3BLACK = "<img src='"+url+"images/black.jpg' height='"+BAR_HEIGHT+"' width="+(BAR_WIDTH*3)+">";
var BAR_3WHITE = "<img src='"+url+"images/white.jpg' height='"+BAR_HEIGHT+"' width="+(BAR_WIDTH*3)+">";
