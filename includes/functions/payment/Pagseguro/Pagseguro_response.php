...
$totalCompra = 0;
    ...
    // $desconto = 0.00;
     ...
     //    $desconto = floatval(str_replace(',','.',$cupom[2]));
	  ...
	  $totalCompraShow = $totalCompra;
	  if($extras>0){
	  $totalCompraShow += $extras;
	  };
      ...
      //$extras = " $numeroCupom | $msg";
         ...
         $txtPrint .= "<br/>
                <h3 style='width:92;background:#ddd;margin-left:5px;padding:20px;text-align:center;font-size:1.2em'  >Total a pagar: $moedaCorrente".getPriceFormat($totalCompraShow)." </h3>    $obs";
...
$txtPrint .= '
	  ...
	  <input type="hidden" name="ref_transacao" value="'.$idPedido.'"  />
	    <input type="hidden" name="extras" value="-'.$desconto.'"  />
	   <input type="hidden" name="extraAmount" value="-'.$desconto.'"  />
...
$linkImgPagseguro = verifyURL("https://p.simg.uol.com.br/out/pagseguro/i/botoes/carrinhoproprio/btnFinalizaBR.jpg");  
 
	
       
$txtPrint .= " <center> <input type='image'  src='$linkImgPagseguro'   name='submit' alt='Pague com o PagSeguro - &eacute; r&aacute;pido, gr&aacute;tis e seguro!' /></form>
