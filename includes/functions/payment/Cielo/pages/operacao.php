...
include_once($dirname.'/includes/include.php'); 
	...
	$orderPrint .="<div style='background:#A2C6DE;padding:10px;margin:10px'>
	 ...
	 if($status=="9"){
	        $msg = "Compra Cancelada pelo Administrador";
             alteraPedidoStatus($order,'CANCELADO',$msg,$StrPedido,$StrPedido);
     }elseif($status=="6"){
            $msg = "Compra Aprovada pelo Administrador";
            alteraPedidoStatus($order,'APROVADO',$msg,$StrPedido,$StrPedido);
     };
