    ...
    <div class='block'>
        ...
        <div class='block-content'>
            <div class='content form-inline'>
              ...
              $checkedPagto = "checked='checked'";        
             if($ativaCielo=="ativaCielo"){
							 
							       
                //if( $current_user->ID==1 || $current_user->ID==4849 ){
               $htmlVar .=" <hr/><br/><div class='field'><input type='radio' class='tipoPagto' name='tipoPagto' value='Cielo' $checkedPagto >  <img src='".$plugin_directory."images/cielo.png' > &nbsp; CIELO  <img src='".$plugin_directory."images/mastercard.png' width='40'> <img src='".$plugin_directory."images/visa.png' width='40'> <img src='".$plugin_directory."images/diners.png' width='40'>   <img src='".$plugin_directory."images/elo.png' width='40'> <img src='".$plugin_directory."images/discovery.png' width='40'> 
      ...
      if($ativaPagseguro=="ativaPagseguro"){    
		  	   ...
		  	   $htmlVar .="<br/><hr/><div class='field'><input type='radio' class='tipoPagto'  name='tipoPagto' value='Pagseguro' $checkedPagto > <img src='".$plugin_directory."images/pagseguro.png' > &nbsp; Pagseguro <img src='".$plugin_directory."images/pagseguro2.png' > 
				   <br/><span style='font-size:10px'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;Função Crédito , Débito e Boleto</span></div><div class='returnajx'></div>";
				   		 $checkedPagto = "";
			}; 
			
			
				if($ativaMoip=="ativaMoip"){    
    		  	$htmlVar .="<br/><hr/><div class='field'><input type='radio' class='tipoPagto'  name='tipoPagto' value='Moip' $checkedPagto > <img src='".$plugin_directory."images/moip.png' > &nbsp; Moip</div><div class='returnajx4'></div>";
		 $checkedPagto = "";
    			};
		     	...
		     	if($ativaPaypal=="ativaPaypal"){    
        		  	$htmlVar .="<br/><hr/><div class='field'><input type='radio' class='tipoPagto'  name='tipoPagto' value='Paypal' $checkedPagto > <img src='".$plugin_directory."images/paypal.png' > &nbsp; Paypal</div><div class='returnajx3'></div>";
		 $checkedPagto = "";
        			};
				     	...
				     	if($ativaGerencianet=="ativaGerencianet"){    
		        		  	$htmlVar .="<br/><hr/><div class='field'><input type='radio' class='tipoPagto'  name='tipoPagto' value='Gerencianet' $checkedPagto > <img src='".$plugin_directory."images/Gerencianet.png' > &nbsp; Gerencianet</div><div class='returnajx5'></div>";
				 $checkedPagto = "";
		        			};
		    ...
		    $htmlVar .="<br/><hr/>	<div class='field'><input type='radio' class='tipoPagto'  name='tipoPagto' value='Deposito' $checkedPagto > <img src='".$plugin_directory."images/deposito.png' > &nbsp; Deposito em conta Corrente    <img src='".$plugin_directory."images/bb.png' width='40'>  <img src='".$plugin_directory."images/itau.png' width='40'>  </div>
		     ";
		     		 $checkedPagto = "";
		     	};
			...
			<br/><hr/>	<div class='field'><input type='radio' class='tipoPagto'  name='tipoPagto' value='Retirada' $checkedPagto > <img src='".$plugin_directory."images/retirada.png' > &nbsp;   	Retirada na Loja . 
