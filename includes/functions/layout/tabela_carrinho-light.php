            ...
            foreach($arrayCarrinho as $key=>$item){ 
             ...
             <?php   
                ...
                <tr>
                    ...
                    <input class='addQtd qtdProdInput' rel='$key' rev='$tabelaVariacao'   type='text' size='2' value='$qtd' 	title='$postID' />
                    
                    <ul class='setas'>
                    <li class='setaUp' rel='$key' rev='$tabelaVariacao'  title='$postID' ></li>
                    <li class='setaDown' rel='$key'  rev='$tabelaVariacao'  title='$postID' ></li>
                    </ul>
        ...
        <?php    $tabelaVar .= "    <h5> Descontos: $moedaCorrente <span   class='descontoCart red'>".getPriceFormat($desconto)."</span><span style='font-size:12px'> ( Cupom Desconto  :$cupom[0]   |   $msg   ) 
            ...
            <?php    $tabelaVar .= "     <h3> TOTAL: <span class='totalCart red'>$moedaCorrente ".getPriceFormat($total)." </span> $obs </h3>
		                ...
		                <div class='buttons'>
                              ...
                              <div class='left' ><br/><a href='".get_bloginfo('url')."/checkout/' class='button-alt    '>Seguir para Pagamento</a></div>
		...
		<?php }else{ ?>
		  ...
		  <?php  $tabelaVar .= "  
           ...
           <p> Para adicionar produtos ao carrinho, procure pelo produto que deseja em nosso site e clique no botão 'Comprar' na página do produto.
            ...
            <li> 3. Sua compra já foi finalizada e Você utilizou as opções Voltar / Avançar da barra de ferramentas de seu navegador.   <a href='".get_permalink(get_IdPaginaPedidos())."'>clique aqui</a> para ir para a pagina de seus pedidos recentes.   </li>
            </ul>";
