...
<?php }; ?>
                                         ...
                                         <?php
                                        	//PLUGIN SHOP FUNCTION --------------------------------------
                                                 ...
                                                 if($precoS>0){ ?>
<?php if( $travaPreco !=true){?>
                                     			 <p class="preco"   ><span style='font-size:0.8em'>Por:</span> <span style='color:red;font-size:1em'><?php echo $moedaCorrente; ?></span> <span  style='color:red;font-size:1.7em;' ><?php echo $precoS; ?></span></p><?php }; ?>
                                           ...
                                           <?php }; ?>
                                                                                                            ...
                                                                                                            <?php $exibeQtdProd = get_option('exibeQtdProd');
                                                                                                                  if($exibeQtdProd  =="sim"){ ?>
                            <?php if( $travaPreco !=true){?>                                                                                  <p class='quantidade'> <label for='qtdProd'> <?php echo $txtSelecioneParcela; ?>:</label>  <input type='text' class='somenteNumeros'  name='qtdProd' id='qtdProd' value='1' style='width:30px' /> </p>    <?php }; ?>
                                                                                                               <?php  }; ?>
                                                 ...
                                                 <?php        if($totalParcela !="" && $txtParcelamentoJuros !="#"){ ?>
                                                    <?php if( $travaPreco !=true){?>    <p class="parc"><strong> <?php echo $totalParcela; ?> <?php echo $txtParcelamentoJuros; ?> </strong></p>  <?php }; ?>
                                                  <?php }; ?>
...
<?php }; ?>
 ...
 <?php if( $travaPreco !=true){?>                                                           			 <p class="preco"  ><span style='font-size:0.8em'>Por:</span> <span style='color:red;font-size:1em'><?php echo $moedaCorrente; ?></span> <span  style='color:red;font-size:1.7em;' ><?php echo $precoS; ?></span></p>
<?php }; ?>
                                                                 ...
                                                                 <?php }; ?>
                                                                                                   ...
                                                                                                   <?php $exibeQtdProd = get_option('exibeQtdProd');
                                                                                                         if($exibeQtdProd  =="sim" && $travaPreco !=true ){ ?>
                                        ...
                                        <?php        if($totalParcela !="" && $txtParcelamentoJuros !="#" && $travaPreco !=true){ ?>
 ...
 <?php }; ?>
        	           ...
        	           <?php }else{ ?>
        	               ...
        	               <br/>
        	               <?php echo $txtprodutoNomeFormContato ?>:<input type="text" id="nomeAviso2" value="" title="" /> <br/>
                   		   <?php echo $txtprodutoEmailFormContato ?>:<input type="text" id="emailAviso2" value="" title="" />
						     <br/>
