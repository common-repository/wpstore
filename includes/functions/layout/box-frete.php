            ...
            <?php  $tabelaVar .= " 	   <div style='display:none'> "; ?>
             <?php }; ?>
    		   ...
    		   <?php if(is_page($idPagina)){ ?>
			    ...
			    $prazoEspecialProd = trim(get_post_meta($post->ID,'entregaEspecialData',true)); 
