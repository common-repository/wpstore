                                                      ...
                                                      $listagemPRelOrderby = trim($_POST['listagemPRelOrderby']); 
                                                       add_option('listagemPRelOrderby',$listagemPRelOrderby ,'','yes'); 
                                                         update_option('listagemPRelOrderby',$listagemPRelOrderby ); 
				                                                        ...
				                                                        $widthImgListagem = trim($_POST['widthImgListagem']); 
				                                                        add_option('widthImgListagem',$widthImgListagem ,'','yes'); 
				                                                        update_option('widthImgListagem',$widthImgListagem); 
                                                         
					                                                     $heightImgListagem = trim($_POST['heightImgListagem']); 
					                                                     add_option('heightImgListagem',$heightImgListagem ,'','yes'); 
					                                                     update_option('heightImgListagem',$heightImgListagem ); 
                                                         
                                                
												
												
 $exibirParcelas = trim($_POST['exibirParcelas']); 
 add_option('exibirParcelasWPSHOP',$exibirParcelas ,'','yes'); 
 update_option('exibirParcelasWPSHOP',$exibirParcelas ); 
 $exibirParcelas = get_option('exibirParcelasWPSHOP'); 
...
<form action="<?php echo verifyURL(get_option( 'siteurl' )) ."/wp-admin/admin.php?page=lista_design";?>"  method="post" >
 ...
 <div class="bloco">      
	...
	<h3>3) EXIBIR TABELA PARCELAMENTO  NA PAGINA DO PRODUTO  </h3>
	
	<span class="seta" rel='exibeParcela'></span>
	<div class="texto" id='exibeParcela'>
	 
	
         <p>SIM : 
         <input type="radio" name="exibirParcelas" value="true"  <?php  if($exibirParcelas=='true' ||$exibirParcelas=='' ){ echo "CHECKED"; }; ?> />
         </p>

         <p>NÃO: 
         <input type="radio" name="exibirParcelas" value="false"  <?php  if($exibirParcelas=='false'){ echo "CHECKED"; }; ?> />
         </p>
    ...
    <h2>tamanho da miniatura das imagens da listagem :</h2>
   
   
   
    <h3>Largura da Imagem</h3>
    <p>Determine a largura da imagem </p>     
    <p><input type="text" name="widthImgListagem"   value='<?php echo $widthImgListagem; ?>' style="width:50%"  /> 
		em pixels</p>    
 
   <h3>Altura da Imagem </h3>
   <p>Determine a largura da imagem</p>
    <br/> 
      <input type="text" id="heightImgListagem" name="heightImgListagem" value="<?php echo $heightImgListagem; ?>" style="width:50%"/>
	  em pixels
   </p>       
