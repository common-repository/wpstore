...
$logradouro = pq('.caixacampobranco .resposta:contains("Logradouro: ") + .respostadestaque:eq(0)')->html();

$replace = array('- de','- até','- lado');
$logradouro = str_replace($replace ,'301red',$logradouro);
$explode = explode('301red',$logradouro);
if( count($explode)>0 ){
	$logradouro = $explode[0];
};
