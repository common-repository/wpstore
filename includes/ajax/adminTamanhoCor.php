<?php  
       ...
       require("../../../../../wp-load.php"); 	 
        ...
        if($msgError==""){
               ...
               $sql = "SELECT * FROM `$tabela` WHERE  	`idPost` = '$postIDP' AND  `tipoVariacao` = 'cor' ORDER BY `showOrder` ASC  LIMIT 0 , 100";
               ...
               foreach ( $fivesdraftsCor as $fivesdraftC ){
                   ...
                   $arrayCoresImg[] = $fivesdraftC->imgAlternativa;
                      ...
                      $sql = "SELECT * FROM `$tabela` WHERE  	`idPost` = '$postIDP' AND  `tipoVariacao` = 'tamanho'  ORDER BY `showOrder` ASC   LIMIT 0 , 100";
